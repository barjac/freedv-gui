...
// than stopping at 85% -- test value (2026-08-29): with the ramp ending
// at 85%, the last 15% of scale was already flat at the fully-fast
...
// LEVEL_METER_FAST_HIGH_TIME_CONSTANT_SEC.
